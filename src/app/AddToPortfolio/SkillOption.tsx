...
const experienceLevels = [
    { levelName: 'Beginner', levelType: '6-10 hrs' },
    { levelName: 'Intermediate', levelType: '10-16 hrs' },
    { levelName: 'Advanced', levelType: '16-30 hrs' },
]
...
export default function SkillOption() {
  ...
  return (
    ...
    <Listbox value={selected} onChange={setSelected}>
      <Label className="block text-sm font-medium text-foreground">Level of Experience</Label>
